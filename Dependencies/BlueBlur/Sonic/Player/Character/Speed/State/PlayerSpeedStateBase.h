...
namespace Sonic::Player
{
    class CTestCrouch : public Hedgehog::Universe::TStateMachine<CPlayerContext>::TState
    {
    public:
        BB_INSERT_PADDING(0x8);
        ...
        static void fCtor(CTestCrouch* This)
        {
            __asm
            {
                mov edi, This
        ...
        CTestCrouch(const bb_null_ctor&) : TState(bb_null_ctor{}) {}

        CTestCrouch() : CTestCrouch(bb_null_ctor{})
        {
            fCtor(this);
        }
    ...
    BB_ASSERT_SIZEOF(CTestCrouch, 0x68);
